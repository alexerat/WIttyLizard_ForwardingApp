...
(req, res) =>
{
                ...
                (err, rows: Array<SQLTutorialRoom>, fields) =>
                {
                    ...
                    if(servers[rows[0].Server_ID] == null || servers[rows[0].Server_ID] == undefined)
                    {
                        ...
                        (err, rows: Array<SQLTutorialServer>, fields) =>
                        {
                            ...
                            let targetServer = { host: servers[rows[0].Server_ID].End_Point, port: servers[rows[0].Server_ID].Port };
    ...
    else
    {
        ...
        let targetServer = { host: servers[sID].End_Point, port: servers[sID].Port };
